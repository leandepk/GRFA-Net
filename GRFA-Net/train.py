...
parser.add_argument('--gt_folder', default='./dataset/clear/')
...
if opt.resume_epoch > 0:
    ...
    resume_path = opt.resume_dir+'net_epoch_'+str(opt.resume_epoch)+'.pth'
